...
const CustomerReviews = () => {
  return (
    <section className="max-container">
      ...
      <p className="info-text m-auto mt-4 max-w-lg text-center">Hear genuine stories from our satisfied customers about their exceptioanal experiences with us.</p>
